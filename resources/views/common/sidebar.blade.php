        ...
        <div>
            ...
            <div class="nav_list">
                @can('view-any', App\Models\Customer::class)
                    <a class="nav_link {{ (request()->segment(1) == 'customers') ? 'active' : '' }}" href="{{ route('customers.index') }}"><i class="fa fa-arrow-right nav_logo-icon"></i><span class="nav_name">Customers</span></a>
                @endcan
                @can('view-any', App\Models\FoodEntry::class)
                    <a class="nav_link {{ (request()->segment(1) == 'food-entries') ? 'active' : '' }}" href="{{ route('food-entries.index') }}"><i class="fa fa-arrow-right nav_logo-icon"></i><span class="nav_name">Food Entries</span></a>
                @endcan
                @can('view-any', App\Models\FoodOrder::class)
                    <a class="nav_link {{ (request()->segment(1) == 'food-orders') ? 'active' : '' }}" href="{{ route('food-orders.index') }}"><i class="fa fa-arrow-right nav_logo-icon"></i><span class="nav_name">Food Orders</span></a>
                @endcan
                @can('view-any', App\Models\Member::class)
                    <a class="nav_link {{ (request()->segment(1) == 'members') ? 'active' : '' }}" href="{{ route('members.index') }}"><i class="fa fa-arrow-right nav_logo-icon"></i><span class="nav_name">Members</span></a>
                @endcan
                ...
                @can('view-any', App\Models\StockIn::class)
                    <a class="nav_link {{ (request()->segment(1) == 'stocks-in') ? 'active' : '' }}" href="{{ route('stocks-in.index') }}"><i class="fa fa-arrow-right nav_logo-icon"></i><span class="nav_name">Stocks In</span></a>
                @endcan
            </div>
